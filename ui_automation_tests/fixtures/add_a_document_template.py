...
def add_a_document_template(context, seed_data_config):
    ...
    document_template = lite_client.seed_document_template.add_template(
        lite_client.seed_picklist
    )
    context.document_template_name = document_template["name"]
    context.document_template_layout = document_template["layout"]["name"]
    context.document_template_restricted_to = [
        document_template["restricted_to_display"][0]
    ]
