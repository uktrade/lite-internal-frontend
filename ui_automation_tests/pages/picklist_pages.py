class PicklistPages:
    ...
    def click_on_picklist_deactivate_button(self):
        self.driver.find_element_by_css_selector(
            self.picklist_deactivate_button
        ).click()

    def click_on_picklist_reactivate_button(self):
        self.driver.find_element_by_css_selector(
            self.picklist_reactivate_button
        ).click()

    def click_on_picklist_type_sub_nav(self, type):
        self.driver.find_element_by_css_selector(
            self.picklist_type_sub_nav + type + '"]'
        ).click()
    ...
    def get_latest_picklist_description(self):
        return self.driver.find_elements_by_css_selector(
            self.picklist_list_description
        )[0].text
    ...
    def type_into_picklist_description(self, description):
        self.driver.find_element_by_name(self.picklist_description_field).send_keys(
            description
        )
    ...
    def context_suggestions_are_displayed(self):
        return self.driver.find_element_by_css_selector(
            self.context_suggestions_overlay
        ).is_displayed()
