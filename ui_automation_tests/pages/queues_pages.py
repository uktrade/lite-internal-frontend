class QueuesPages:
    ...
    def is_case_on_the_list(self, app_id):
        ...
        while no == 0:
            ...
            no = len(
                self.driver.find_elements_by_css_selector("[href*='" + app_id + "']")
            )
        return no
    ...
    def click_queue_edit_button(self, num):
        self.driver.find_elements_by_css_selector(self.table_rows)[
            num
        ].find_element_by_css_selector(self.queues_edit_link).click()
