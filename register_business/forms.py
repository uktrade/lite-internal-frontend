        ...
        [
            ...
            conditional(
                ...
                Form(
                    ...
                    questions=[
                        TextInput(
                            title=get_string("register_business.email"),
                            name="user.email",
                        ),
                        TextInput(
                            title=get_string("register_business.first_name"),
                            name="user.first_name",
                        ),
                        TextInput(
                            title=get_string("register_business.last_name"),
                            name="user.last_name",
                        ),
                        TextInput(
                            title=get_string("register_business.eori_number"),
                            name="eori_number",
                        ),
                        TextInput(
                            title=get_string("register_business.uk_vat_number.title"),
                            description=get_string(
                                "register_business.uk_vat_number.description"
                            ),
                            optional=True,
                            name="vat_number",
                        ),
                ...
                Form(
                    ...
                    questions=[
                        TextInput(
                            title=get_string("register_business.name"), name="name"
                        ),
                        TextInput(
                            title=get_string("register_business.eori_number"),
                            name="eori_number",
            ...
            Form(
                ...
                questions=[
                    TextInput(
                        title=get_string("register_business.name_of_site"),
                        name="site.name",
                    ),
                    Heading(
                        get_string("register_business.where_is_the_exporter_based"),
                        HeadingStyle.M,
                    ),
            ...
            conditional(
                ...
                Form(
                    ...
                    helpers=[
                        HelpSection(
                            "Help", get_string("register_business.default_user")
                        )
                    ],
                ),
            ),
    ...
    return FormGroup(
        [
            ...
            Form(
                ...
                questions=[
                    TextInput(
                        title=get_string("register_business.email"), name="user.email"
                    ),
                    TextInput(
                        title=get_string("register_business.first_name"),
                        name="user.first_name",
