...
from libraries.forms.components import Form, BackLink, Question, InputType, HiddenField, Select


def create_ecju_queries_form(case, case_url, picklists):
    return Form(get_string('cases.ecju_queries.title'),
                '',
                [
                    ...
                    Select(title='Ask a quick question', description='Select a pre-filled question', name='picklist',
                           options=picklists,
                           optional=True)
                ],
