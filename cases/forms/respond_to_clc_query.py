    ...
    return Form(
        ...
        questions=[
            ...
            HTMLBlock(
                ...
                '<p class="govuk-body-m">'
                + default(case["query"]["good"].get("control_code"), "N/A")
                + "</p>"
                "</div>"
                "</div>"
            ),
        ...
        back_link=BackLink(
            "Back to case", reverse_lazy("cases:case", kwargs={"pk": case["id"]})
        ),
    )
